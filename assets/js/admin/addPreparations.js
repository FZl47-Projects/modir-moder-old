...
CatageoryNameBtn.addEventListener("click", async () => {
  ...
  console.log(await PreparationsPostCategory(data));
...
const renderPage = async () => {
  const category = await PreparationsGetCategory(userid);
...
// send data 
        fetch("http://185.252.28.87:8000/food/Preparations/food/all/", requestOptions)
          ...
          successAlert("success", "لطفا کمی صبر کنید");
            ...
            name.forEach(async(item, index) => {
              ...
              console.log(await PreparationsInsertMaterialFood(data));
  ...
  loading.style.display="block"
        ...
        fetch("http://185.252.28.87:8000/food/Preparations/food/all/", requestOptions)
          ...
          .then((result) => {
            ...
            setTimeout(() => {
              location.href = "./Preparations.html";
            }, 3000);
          })
          .catch((error) => {
            console.log("error", error)
