...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-1^h2b@g64uh%*5154t@@&&%j@67%%hm#&s-0&4c02vkr9$z6!z')
...
WSGI_APPLICATION = 'modirModern.wsgi.application'
